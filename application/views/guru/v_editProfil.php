...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('G_user_profil/edit'); ?>
            <div class="form-group row">
                <label for="kode_guru" class="col-sm-2 col-form-label">kode_guru</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kode_guru" name="kode_guru" value="<?= $user['kode_guru']; ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file">
                                ...
                                <p>*file .gif|.jpg|.png tidak boleh lebih dari 2MB</p>
                            </div>
                        </div>
                    </div>
                </div>
