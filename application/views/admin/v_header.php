...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('A_guru') ?>">
          <i class="fas fa-user-tie"></i>
          <span>Guru</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('A_murid') ?>">
          <i class="fas fa-user"></i>
          <span>Murid</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('A_mapel') ?>">
          <i class="fas fa-book"></i>
          <span>Mata Pelajaran</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('A_kelas') ?>">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('A_dataUsr') ?>">
