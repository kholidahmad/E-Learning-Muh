  ...
  $.ajax({
    ...
    success: function(data){
      ...
      $.each(data.dataKls, function(idx, obj){
        ...
        table += '<td> <button class="btn btn-outline-primary btn-sm" onClick="aksiInputTugas(\'' + obj.kode_kls + '\', \'' + obj.nama_kls + '\')"> Input Tugas </button> </td>';
        table += '</tr>';
      });
      table += '</tbody>';
      table +=  '</table>';
...
function aksiInputTugas(id, nama_kls){
