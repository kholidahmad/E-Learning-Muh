  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <img height="60" width="45" src="<?= base_url('assets/img/profil/simpon.png') ?>">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('S_dashboard') ?>">
          <i class="fas fa-fw fa-home"></i>
          <span>Dashboard</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('S_mapel') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('S_materi') ?>">
          <i class="fas fa-fw fa-book"></i>
          <span>Materi</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('S_tugas') ?>">
          <i class="fas fa-tasks"></i>
          <span>Tugas</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('S_quiz') ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php echo base_url('s_user_profil/index') ?>">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url('s_user_profil/edit') ?>">
                  <i class="fas fa-user-edit fa-sm fa-fw mr-2 text-gray-400"></i>
                  Edit Profile
                </a>
                <a class="dropdown-item" href="<?php echo base_url('s_user_profil/changePassword') ?>">
                  <i class="fas fa-key fa-sm fa-fw mr-2 text-gray-400"></i>
                  Change Password
                </a>
                <a class="dropdown-item" href="<?php echo base_url('s_user_profil/changeUsername') ?>">
                  <i class="fas fa-key fa-sm fa-fw mr-2 text-gray-400"></i>
                  Change Username
                </a>
